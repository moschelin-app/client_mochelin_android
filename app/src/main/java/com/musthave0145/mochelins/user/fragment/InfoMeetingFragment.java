...
import com.musthave0145.mochelins.adapter.InfoMeetingAdapter;
 ...
 * Use the {@link InfoMeetingFragment#newInstance} factory method to
...
public class InfoMeetingFragment extends Fragment {
     ...
     * @return A new instance of fragment InfoMeetingFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static InfoMeetingFragment newInstance(String param1, String param2) {
        InfoMeetingFragment fragment = new InfoMeetingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_info_meeting, container, false);
        ...
        adapter = new InfoMeetingAdapter(getContext(), meetingArrayList);
    ...
    private void get_data(){
        ...
        Call<UserInfoMeetingRes> call = api.user_meeting("Bearer " + token, user.id, offset, limit);


        call.enqueue(new Callback<UserInfoMeetingRes>() {
            @Override
            public void onResponse(Call<UserInfoMeetingRes> call, Response<UserInfoMeetingRes> response) {
                progressBar.setVisibility(View.INVISIBLE);
            ...
            @Override
            public void onFailure(Call<UserInfoMeetingRes> call, Throwable t) {
                progressBar.setVisibility(View.INVISIBLE);
            }
        });
    }
